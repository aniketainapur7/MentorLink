        ...
        <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 p-1 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 flex w-full">
                <button
                    ...
                    className={`flex-1 px-4 lg:px-6 py-2 rounded-lg font-medium transition-colors text-sm lg:text-base ${activeTab === "upcoming"
                ...
                <button
                    ...
                    className={`flex-1 px-4 lg:px-6 py-2 rounded-lg font-medium transition-colors text-sm lg:text-base ${activeTab === "past"
                            ? "bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300"
                            : "text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white"
                        }`}
                >
                    ...
                    acceptedSessions.map((session, index) => (
                        ...
                        >
                            <div className="flex flex-col sm:flex-row sm:items-start justify-between mb-4 gap-3">
                                ...
                                <span
                                    className={`px-3 py-1 rounded-full text-sm font-medium self-start ${session.status === "confirmed"
